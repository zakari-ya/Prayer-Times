document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateLanguage(lang) {
        ...
        document.body.className = `d-flex align-items-center justify-content-center py-4 lang-${lang}`;
        ...
        if (nextPrayerNameElement.textContent !== "Loading...") {
            ...
            nextPrayerNameElement.textContent = t[prayerName] || nextPrayerNameElement.textContent;
        }
    }
    ...
    function updateCurrentDate(lang) {
        ...
        try {
            ...
            currentDateElement.textContent = now.toLocaleDateString("en-US", dateOptions.en);
        }
    }
    ...
    function startCountdown(prayerTimes) {
        ...
        const t = translations[lang];
        nextPrayerNameElement.textContent = t[nextPrayer.name.toLowerCase()] || nextPrayer.name;
